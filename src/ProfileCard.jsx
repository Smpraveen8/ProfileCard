...
function res() {
  window.open('https://raw.githubusercontent.com/Smpraveen8/ProfileCard/main/public/PraveenSM.pdf', '_blank');
}
...
function User() {
  return (
    <div className='card-container'>
      ...
      {/* Profile Image */}
      <img src='/photo1.jpg' className='image' width="100" height="100" alt="Profile" />
      ...
      <div className='button'>
        {/* Button to download/view resume */}
